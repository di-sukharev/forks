...
export interface OpenCommandPiforksgs {
	type: 'open';
	fileURIs?: string[];
	folderURIs?: string[];
...
export interface OpenExternalCommandPiforksgs {
	type: 'openExternal';
	uris: string[];
}

export interface StatusPiforksgs {
	type: 'status';
}

export interface ExtensionManagementPiforksgs {
...
export type PipeCommand = OpenCommandPiforksgs | StatusPiforksgs | OpenExternalCommandPiforksgs | ExtensionManagementPiforksgs;
...
export class CLIServerBase {
	...
	private async open(data: OpenCommandPiforksgs): Promise<undefined> {
	...
	private async openExternal(data: OpenExternalCommandPiforksgs): Promise<undefined> {
	...
	private async manageExtensions(data: ExtensionManagementPiforksgs): Promise<string | undefined> {
	...
	private async getStatus(data: StatusPiforksgs): Promise<string | undefined> {
