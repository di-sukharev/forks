...
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
	group: '2_apforksance',
	title: localize({ key: 'miApforksance', comment: ['&& denotes a mnemonic'] }, "&&Apforksance"),
	submenu: MenuId.MenubarApforksanceMenu,
	order: 1
});
...
// --- Tab Bar Submenu in View Apforksance Menu
...
// --- Editor Actions Position Submenu in View Apforksance Menu
...
registerAction2(class extends Action2 {
	...
	run(accessor: ServicesAccessor): void {
		...
		commandService.executeCommand('workbench.action.moveforksExtensionToAuxBar');
	}
});
