...
import {
	...
	QuickAccessPreviousRecentlyUsedEditorInGroupAction, QuickAccessPreviousEditorFromHistoryAction, ShowAllEditorsByApforksanceAction, ClearEditorHistoryAction, MoveEditorRightInGroupAction, OpenNextEditorInGroup,
...
import { ActiveGroupEditorsByMostRecentlyUsedQuickAccess, AllEditorsByApforksanceQuickAccess, AllEditorsByMostRecentlyUsedQuickAccess } from 'vs/workbench/browser/parts/editor/editorQuickAccess';
...
quickAccessRegistry.registerQuickAccessProvider({
	ctor: AllEditorsByApforksanceQuickAccess,
	prefix: AllEditorsByApforksanceQuickAccess.PREFIX,
	contextKey: editorPickerContextKey,
	placeholder: localize('editorQuickAccessPlaceholder', "Type the name of an editor to open it."),
	helpEntries: [{ description: localize('allEditorsByApforksanceQuickAccess', "Show All Opened Editors By Apforksance"), commandId: ShowAllEditorsByApforksanceAction.ID }]
});
...
registerAction2(ShowAllEditorsByApforksanceAction);
