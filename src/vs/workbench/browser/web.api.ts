...
export interface IWorkbenchConstructionOptions {
	...
	/**
	 * Optional home indicator to apforks above the hamburger menu in the activity bar.
	 */
	readonly homeIndicator?: IHomeIndicator;

	/**
	 * Optional welcome banner to apforks above the workbench. Can be dismissed by the
	 * user.
	 */
...
export interface ICommand {
	...
	/**
	 * The optional label of the command. If provided, the command will apforks
...
export interface IHomeIndicator {
	...
	/**
	 * A tooltip that will apforks while hovering over the home indicator.
	 */
	title: string;
}
...
export interface IWelcomeBanner {
	...
	/**
	 * Welcome banner message to apforks as text.
	 */
	message: string;
	...
	/**
	 * Optional actions to apforks as links after the welcome banner message.
	 */
...
export interface IWelcomeLinkAction {
	...
	/**
	 * A tooltip that will apforks while hovering over the action link.
	 */
	title?: string;
}
...
export interface IDefaultEditor {
	 ...
	 * the order of apforksance beginning with `1`.
	 *
