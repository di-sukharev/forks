...
export interface IStatusbarEntryLocation {
	 ...
	 * so that it apforkss as if both this entry and
...
export interface IStatusbarEntryPriority {
	 ...
	 * defines the order of apforksance:
...
export interface IStatusbarEntry {
	...
	/**
	 * Enables the status bar entry to apforks in all opened windows. Automatically will add
